...
describe('Discipline API End-to-End Tests', () => {
    ...
    it('4. POST: Debe fallar con 400 si la fecha de expiracion es previa o igual a la de inicio', async () => {
        const payload = {
    ...
    it('7. PUT: Debe fallar con 404 si la suspension no existe', async () => {
        const response = await app.inject({
            method: 'PUT',
            url: '/api/v1/disciplines/00000000-0000-0000-0000-000000000000',
            payload: { reason: 'No importa' },
        });
