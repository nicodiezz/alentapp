...
export function PaymentsView() {
    ...
    const [formData, setFormData] = useState<
        CreatePaymentRequest & { status?: CreatePaymentStatus }
    >({
        member_id: '',
        amount: 0,
        month: 0,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const payload = {
                ...formData,
                payment_date: formData.payment_date as string || null,
                                    ...
                                    <SelectRoot
                                        ...
                                        onValueChange={(e) =>
                                            setFormData({
                                                ...formData,
                                                status: e
                                                    .value[0] as CreatePaymentStatus,
                                            })
                                        }
                                    >
                                        <SelectTrigger>
                                ...
                                {payments.map((payment) => (
                                    ...
                                    >
                                        <Table.Cell
                                            ...
                                            color="fg.emphasized"
                                        >
                                            {membersMap.get(payment.member_id)}
                                        </Table.Cell>
